"""Regression checks for the vertex-move-endgame-mark casebook."""
...
from casebook.harness import assert_expected, vertex_move_endgame_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vertex_move_endgame_mark_summary(), assert_expected())
